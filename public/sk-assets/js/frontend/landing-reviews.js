/* Landing — Google reviews carousel (#skReviewsCarousel) */
(function () {
    'use strict';

    var root = document.getElementById('skReviewsCarousel');
    if (!root) return;

    var track = root.querySelector('.sk-rev-track');
    var slides = [].slice.call(root.querySelectorAll('.sk-rev-slide'));
    var prev = root.querySelector('.sk-rev-prev');
    var next = root.querySelector('.sk-rev-next');
    var dotsWrap = root.querySelector('.sk-rev-dots');
    ...
    function goTo(i) {
        ...
        var gap = parseFloat(getComputedStyle(root).getPropertyValue('--sk-rev-gap')) || 26;
