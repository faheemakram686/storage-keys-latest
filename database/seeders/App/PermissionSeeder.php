...
use Database\Seeders\App\Traits\AdminPermissions;
...
{
    use DisableForeignKeys, Permissions, AdminPermissions;
    /**
...
//            ],
        ...
        $adminPermissions = method_exists($this, 'adminpermissions') ? $this->adminpermissions($admin, $appType) : [];
