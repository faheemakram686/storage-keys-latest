...
//   Route::any('delete-contract',[ContractController::class,'deleteContract']);
   ...
   Route::any('print-invoice/{id}',[InvoiceController::class,'printInvoice'])->middleware('hashid');
   Route::any('pdf-invoice/{id}',[InvoiceController::class,'pdfInvoice'])->middleware('hashid');
