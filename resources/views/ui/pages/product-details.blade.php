...
<div class="ltn__breadcrumb-area text-left bg-overlay-white-30 bg-image "  data-bg="{{ asset('assets/images/frontend/bg/14.jpg') }}">
    <div class="container">
        <div class="row">
            <div class="col-lg-12">
                        ...
                        <div class="col-md-6">
                            <div class="ltn__shop-details-img-gallery">
                                ...
                                <div class="single-large-img">
                                        <a href="{{ asset('assets/images/frontend/product/1.png') }}" data-rel="lightcase:myCollection">
                                            <img src="{{ asset('assets/images/frontend/product/1.png') }}" alt="Image">
                                        </a>
                                    </div>
                                    <?php } ?>
                                </div>
                                    ...
                                    <div class="ltn__comment-inner">
                                        <ul>
                                            <li>
                                                <div class="ltn__comment-item clearfix">
                                                    <div class="ltn__commenter-img">
                                                        <img src="{{ asset('assets/images/frontend/testimonial/1.jpg') }}" alt="Image">
                                                    </div>
                                            ...
                                            <li>
                                                <div class="ltn__comment-item clearfix">
                                                    <div class="ltn__commenter-img">
                                                        <img src="{{ asset('assets/images/frontend/testimonial/3.jpg') }}" alt="Image">
                                                    </div>
                                                    <div class="ltn__commenter-comment">
                                                        <h6><a href="#">Adam Smit</a></h6>
                                                        <div class="product-ratting">
                                            ...
                                            <li>
                                                <div class="ltn__comment-item clearfix">
                                                    <div class="ltn__commenter-img">
                                                        <img src="{{ asset('assets/images/frontend/testimonial/2.jpg') }}" alt="Image">
                                                    </div>
                                                    <div class="ltn__commenter-comment">
                                                        <h6><a href="#">Adam Smit</a></h6>
                                                        <div class="product-ratting">
                                ...
                                <div class="row">
                                    <div class="col-lg-6 col-12">
                                        <div class="modal-product-img">
                                            <img src="{{ asset('assets/images/frontend/product/4.png') }}" alt="#">
                                        </div>
                                    </div>
                                    <div class="col-lg-6 col-12">
                                        ...
                                        <div class="modal-product-img">
                                         ...
                                         <div class="additional-info d-none">
                                            ...
                                            <div class="payment-method">
                                                <img src="{{ asset('assets/images/frontend/icons/payment.png') }}" alt="#">
                                            </div>
                                         </div>
                                    </div>
                                </div>
