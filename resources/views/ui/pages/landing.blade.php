        ...
        <div class="sk-container">
            ...
            <div class="sk-logos sk-reveal">
                ...
                <div class="sk-logos-row">
                    <img src="{{ asset('sk-assets/assets/images/frontend/landing/inline-12.png') }}" alt="Partner" loading="lazy" decoding="async" width="160" height="51">
                    <img src="{{ asset('sk-assets/assets/images/frontend/landing/inline-13.png') }}" alt="Partner" loading="lazy" decoding="async" width="160" height="56">
                    <img src="{{ asset('sk-assets/assets/images/frontend/landing/inline-14.png') }}" alt="Partner" loading="lazy" decoding="async" width="160" height="55">
                    <img src="{{ asset('sk-assets/assets/images/frontend/landing/inline-15.png') }}" alt="Partner" loading="lazy" decoding="async" width="160" height="48">
                    <img src="{{ asset('sk-assets/assets/images/frontend/landing/inline-16.png') }}" alt="Partner" loading="lazy" decoding="async" width="160" height="48">
                </div>
            </div>
        </div>
    </section>
