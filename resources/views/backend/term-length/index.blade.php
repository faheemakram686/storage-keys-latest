...
@section('content')
            ...
            <div class="nk-block-head">
                <div class="nk-block-between">
                    <div class="nk-block-head-content">
                        <h3 class="nk-block-title page-title">Term-Length List</h3>
                            ...
                            <div class="toggle-expand-content" data-content="pageMenu">
                                <ul class="nk-block-tools g-3">
                                    <li class="nk-block-tools-opt">
                                        <a href="#" class="btn btn-primary btn-sm"  data-toggle="modal" data-target="#addCountry"><em class="icon ni ni-plus"></em><span>Add Term-Length</span></a>
                                    </li>
                                </ul>
                            </div>
                        </div>
                ...
                <div class="card-inner">
                    <table class="datatable-init-export nk-tb-list nk-tb-ulist" data-auto-responsive="true"  id="datatable" >
                        ...
                        <tr class="nk-tb-item nk-tb-head">
                            ...
                            <th class="nk-tb-col"><span class="sub-text">Term Period</span></th>
                            <th class="nk-tb-col"><span class="sub-text">Discount %</span></th>
                            <th class="nk-tb-col"><span class="sub-text">Short Description</span></th>
        ...
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title text-capitalize" id="ajax_model_title">Add New Term-Length </h5>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                </div>
                <div class="modal-body" data-form="ajax-form-modal">
                        <form method="post" action="{{ url('admin/save-term-length') }}" id="CountryForm">
                            @csrf
                            <div class="row">
                                <div class="col-md-12">
    ...
    <div class="modal fade" tabindex="-1" role="dialog" data-backdrop="static" data-keyboard="false" id="editCountry" aria-hidden="true">
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title text-capitalize" id="ajax_model_title">Edit Term-Length</h5>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                </div>
                <div class="modal-body" data-form="ajax-form-modal">
                    <form method="post" action="{{ url('admin/update-term-length') }}" id="updateCountryForm">
                        @csrf
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <label> Title <span class="text-danger">*</span></label>
                                    <input class="form-control" type="text" name="edit_title" placeholder="Title" required>
                                </div>
                            </div>
                            <div class="col-md-12">
                                <div class="form-group">
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    <label> Description <span class="text-danger"></span></label>
                                    <textarea class="form-control" type="text" name="edit_description" placeholder="Description" ></textarea>
                                </div>
                            </div>
                            <div class="col-md-12">
                                <div class="form-group">
    ...
    <script>
        $(document).ready(function() {
            ...
            $('#CountryForm').on('submit', function(e) {
                ...
                $.ajax({
                    type: "get",
                    url: '{{ url('admin/save-term-length') }}',
                    data: formData,
                    contentType: false,
                    processData: false,
                    beforeSend: function() {
                ...
                $.ajax({
                    ...
                    success: function(data) {
                        ...
                        for (i = 0; i < data.length; i++) {
                            ...
                            ' <td class="nk-tb-col nk-tb-col-tools">'+data[i].term_period+'</td>'+
                            ' <td class="nk-tb-col nk-tb-col-tools">'+data[i].discount_percentage+'</td>'+
            ...
            $('#countryTable').on('click', '.btn-delete', function() {
                var id = $(this).attr('data');
                    $.ajax({
                        url: '{{ url('admin/delete-term-length') }}',
                        type: 'get',
                        async: false,
                        dataType: 'json',
                        data: { id: id},
            ...
            $('#countryTable').on('click', '.btn-edit', function() {
                ...
                $.ajax({
                    url: '{{ url('admin/edit-term-length') }}',
                    type: 'get',
                    async: false,
                    dataType: 'json',
                    data: { id: id },
                    success: function(res) {
                        ...
                        $('input[name=edit_term_period]').val(res.term_period);
                        $('input[name=edit_discount_percentage]').val(res.discount_percentage);
            ...
            $('#updateCountryForm').on('submit', function(e) {
                ...
                $.ajax({
                    type: "get",
                    url: '{{ url('admin/update-term-length') }}',
                    data: formData,
                    contentType: false,
                    processData: false,
                    beforeSend: function() {
