                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            <input class="form-control" type="hidden" name="id" value="{{$data['contract'][0]->id}}" required>
                ...
                $.ajax({
                    ...
                    success: function(data) {
                        ...
                        for (i = 0; i < data.length; i++) {
                            ...
                            var name = data[i].user.first_name.charAt(0);
                             name += data[i].user.last_name.charAt(0);
