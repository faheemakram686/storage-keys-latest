                        ...
                        <div class="row g-4">
                            ...
                            <div class="col-lg-6">
                                ...
                                <div class="form-group">
                                    ...
                                    <input class="form-control" type="number" step="any" name="invoice_value" id="invoice_value" placeholder="Order Value" >
                                </div>
                                <div class="form-group">
                            ...
                            <div class="col-lg-6">
                                <div class="form-group">
                                    ...
                                    <input class="form-control" type="date" value="{{$data['invoice'][0]->invoice_date}}" name="invoice_date" placeholder="Invoice Date" >
                                </div>
                            </div>
                            <div  class="col-lg-6" >
                                <div class="form-group">
                                    <label>Due Date <span class="text-danger">*</span></label>
                                    <input class="form-control" type="date" value="{{$data['invoice'][0]->due_date}}" name="due_date" placeholder="Due Date" >
                                </div>
                            </div>
                            <div class="col-lg-6">
                                <div class="form-group">
            ...
            function getEstimate(contract_id) {
                $.ajax({
                    ...
                    success: function(data) {
                        ...
                        const storageUnitId = (data.contract[0].estimate.storageunit && data.contract[0].estimate.storageunit.id) ? data.contract[0].estimate.storageunit.id : '';
                    ...
                    console.log(data)
                        ...
                        for (i = 0; i < data.length; i++) {
                            ...
                            html += '<tr id="row'+dr+'" class="dynamic-added">'+
                                ...
                                '<td><input type="number" step="any" name="invoiceItems[qty][]" placeholder="QTY" class="form-control qty_list" value="' + data[i].qty + '" min="0" /></td>'+
                                '<td><input type="text" name="invoiceItems[unit][]" placeholder="Unit" class="form-control unit_list" value="" /></td>'+
                                ...
                                '<td><input type="number" step="any" name="invoiceItems[total][]" placeholder="Total" class="form-control total" value="' + data[i].total + '"  min="0.00" /></td>'+
                                '<td><button type="button" name="remove" id="'+dr+'" class="btn btn-sm btn-danger btn_remove"><em class="icon ni ni-trash-empty-fill"></em></button></td>'+
                                '</tr>';
