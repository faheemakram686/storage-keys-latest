            ...
            <div class="row g-4">
                ...
                <div class="align-self-end col-lg-3">
                    <div class="custom-control custom-control-md custom-checkbox custom-control">
                        <input type="checkbox" class="custom-control-input assign-all" id="assign_all" >
                                        ...
                                        <div class="card-body">
                                            <div class="accordion-item">
                                                ...
                                                <div class="custom-control custom-control-md custom-checkbox custom-control pb-2">
                                                    <input type="checkbox" class="custom-control-input group-permissions" id="{{ $key }}"   />
                                                    <label class="custom-control-label text-capitalize" for="{{ $key }}">Select all</label>
                                                </div>
                                                @foreach($permissions as $permission)
                                                    <div class="accordion-body collapse @if($isEdit && $role->hasPermission($permission->name)) show @endif " id="{{$key}}" data-parent="#accordion-1">
                                                        <div class="accordion-inner">
                                                            <div>
                                                                <div class="custom-control custom-control-md custom-checkbox custom-control pb-2">
                                                                    <input type="checkbox" class="custom-control-input" value="{{($permission->id)}}" id="{{$permission->id }}" name="permissions[]"  @if($isEdit && $role->hasPermission($permission->name)) checked @endif >
