                                ...
                                <div class="card-inner card-inner-lg">
                                    <div class="nk-block-head">
                                        <div class="nk-block-between d-flex justify-content-between">
                                            <div class="nk-block-head-content">
                                                <h4 class="nk-block-title">Leads</h4>
                                            ...
                                            <div class="d-flex align-center">
                                                <div class="nk-tab-actions me-n1">
                                                    @can('create_lead')
                                                        <a href="{{url('admin/create-lead-customer')}}/{{$data['customer']->id}}" class="btn btn-primary btn-sm"  ><em class="icon ni ni-plus"></em><span>Add New Lead</span></a>
                                                    @endcan
                                        ...
                                        <div class="card border border-light">
                                            <table class=" table table-md datatable-init-export nk-tb-list nk-tb-ulist" data-auto-responsive="true"  id="" >
                                                ...
                                                <tr class="nk-tb-item nk-tb-head">
                                                    ...
                                                    <th class="nk-tb-col"><span class="sub-text">Lead Source</span></th>
        ...
        $(document).ready(function() {
            ...
            function getAllCities() {
                ...
                $.ajax({
                    ...
                    url: '{{ url('admin/get-customer-leads') }}',
                    type: 'get',
                    async: false,
                    dataType: 'json',
                    ...
                    success: function(data) {
                        ...
                        for (i = 0; i < data.length; i++) {
                            ...
                            html += ' <tr class="nk-tb-item odd">'+
                                ...
                                '<li><a href={{url('admin/estimate')}}/'+data[i].id+' class="btn-estimate" data='+data[i].id+'><em class="icon ni ni-edit"></em><span>Lead Estimate</span></a></li>'+
