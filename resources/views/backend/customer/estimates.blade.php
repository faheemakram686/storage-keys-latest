                    ...
                    success: function(data) {
                        ...
                        for (i = 0; i < data.length; i++) {
                            ...
                            html += ' <tr class="nk-tb-item odd">'+
                                ...
                                ' <td class="nk-tb-col nk-tb-col-tools"><a href={{url('admin/estimate/detail')}}/' + data[i].id + ' class="btn-edit" data='+data[i].id+'>' + data[i].storageunit.storage_unit_name + '/' + data[i].term_length.title + '</a></td>' +
                                ...
                                ' <td class="nk-tb-col nk-tb-col-tools">' + data[i].storageunit.price + '</td>'+
