                    ...
                    success: function(data) {
                        ...
                        for (i = 0; i < data.length; i++) {
                            ...
                            html += ' <tr class="nk-tb-item odd">'+
                                ...
                                ' <td class="nk-tb-col nk-tb-col-tools"><a href={{url('admin/customer/profile')}}/' + data[i].id + '>' + data[i].company_name + '</a></td>' +
                                ' <td class="nk-tb-col nk-tb-col-tools">' +  ((data[i].first_name == null) ? ' ' : data[i].first_name) + ' ' + ((data[i].last_name == null) ? ' ' : data[i].last_name)  + '</td>'+
