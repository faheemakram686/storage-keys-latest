                        ...
                        <div class="simplebar-content" style="padding: 0px;">
                            <div class="card-inner">
                                <div class="user-card">
                                    ...
                                    <div class="user-info">
                                        <span class="lead-text">{{$data['invoice'][0]->invoice_no}}</span>
                            ...
                            <div class="card-inner p-0">
                                <ul class="link-list-menu">
                                    <li><a class="{{ Route::is('detail-invoice') ? 'active' : '' }}" href="{{url('admin/invoice/detail/'.$data['invoice'][0]->id)}}"><em class="icon ni ni-user-fill-c"></em><span>Invoice Detail</span></a></li>
