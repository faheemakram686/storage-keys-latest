...
@section('content')
            ...
            <div class="nk-block-head">
                <div class="nk-block-between">
                    <div class="nk-block-head-content">
                        <h3 class="nk-block-title page-title">Storage Type List</h3>
                            ...
                            <div class="toggle-expand-content" data-content="pageMenu">
                                <ul class="nk-block-tools g-3">
                                    <li class="nk-block-tools-opt">
                                        <a href="#" class="btn btn-primary btn-sm"  data-toggle="modal" data-target="#addCountry"><em class="icon ni ni-plus"></em><span>Add Storage Type</span></a>
                                    </li>
                                </ul>
                            </div>
                        </div>
        ...
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title text-capitalize" id="ajax_model_title">Add New Storage Type</h5>
                ...
                <div class="modal-body" data-form="ajax-form-modal">
                    ...
                    <form method="post" action="{{ url('admin/save-storage-type') }}" id="CountryForm">
                        @csrf
                        <div class="row g-4">
    ...
    <div class="modal fade" tabindex="-1" role="dialog" id="editCountry" aria-hidden="true">
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title text-capitalize" id="ajax_model_title">Edit Storage Type</h5>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                </div>
                <div class="modal-body" data-form="ajax-form-modal">
                    ...
                    <form method="post" action="{{ url('admin/update-storage-type') }}" id="updateCountryForm">
                        @csrf
                        <div class="row g-4">
        ...
        $(document).ready(function() {
            ...
            function getAllCities() {
                ...
                $.ajax({
                    ...
                    url: '{{ url('admin/get-storage-type') }}',
                    type: 'get',
                    async: false,
                    dataType: 'json',
            ...
            $('#countryTable').on('click', '.btn-delete', function() {
                var id = $(this).attr('data');
                    $.ajax({
                        url: '{{ url('admin/delete-storage-type') }}',
                        type: 'get',
                        async: false,
                        dataType: 'json',
                        data: { id: id},
