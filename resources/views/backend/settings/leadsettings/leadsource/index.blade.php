            ...
            <div class="nk-block-head">
                <div class="nk-block-between">
                    <div class="nk-block-head-content">
                        <h3 class="nk-block-title page-title">Lead Source List</h3>
                            ...
                            <div class="toggle-expand-content" data-content="pageMenu">
                                <ul class="nk-block-tools g-3">
                                    <li class="nk-block-tools-opt">
                                        <a href="#" class="btn btn-primary btn-sm"  data-toggle="modal" data-target="#addCountry"><em class="icon ni ni-plus"></em><span>Add Lead Source</span></a>
                                    </li>
                                </ul>
                            </div>
                        </div>
        ...
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title text-capitalize" id="ajax_model_title">Add New Lead Source</h5>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                </div>
                <div class="modal-body" data-form="ajax-form-modal">
                        <form method="post" action="{{ url('admin/save-lead-source') }}" id="CountryForm">
                            @csrf
                            <div class="row">
                                <div class="col-md-6">
    ...
    <div class="modal fade" tabindex="-1" role="dialog" data-backdrop="static" data-keyboard="false" id="editCountry" aria-hidden="true">
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body" data-form="ajax-form-modal">
                    <form method="post" action="{{ url('admin/update-lead-source') }}" id="updateCountryForm">
                        @csrf
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
    ...
    <script>
        $(document).ready(function() {
            ...
            $('#CountryForm').on('submit', function(e) {
                ...
                $.ajax({
                    type: "get",
                    url: '{{ url('admin/save-lead-source') }}',
                    data: formData,
                    contentType: false,
                    processData: false,
                    beforeSend: function() {
            ...
            $('#countryTable').on('click', '.btn-delete', function() {
                var id = $(this).attr('data');
                    $.ajax({
                        url: '{{ url('admin/delete-lead-source') }}',
                        type: 'get',
                        async: false,
                        dataType: 'json',
                        data: { id: id},
            ...
            $('#countryTable').on('click', '.btn-edit', function() {
                ...
                $.ajax({
                    url: '{{ url('admin/edit-lead-source') }}',
                    type: 'get',
                    async: false,
                    dataType: 'json',
                    data: { id: id },
            ...
            $('#updateCountryForm').on('submit', function(e) {
                ...
                $.ajax({
                    type: "get",
                    url: '{{ url('admin/update-lead-source') }}',
                    data: formData,
                    contentType: false,
                    processData: false,
                    beforeSend: function() {
