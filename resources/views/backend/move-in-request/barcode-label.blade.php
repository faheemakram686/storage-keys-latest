...
<div class="container-fluid text-center">
    ...
    @isset($data)
{{--        @dd($data['moveInRequest'][0]->contract->subject);--}}
    <div class="row">
        @foreach($data['barcode'] as $barcode)
        <div class="col-lg-6 offset-lg-2">
                <h5 class="mb-2">{{config('app.name')}}</h5>
                <h6 class="mb-2">{{$data['moveInRequest'][0]->customer->company_name}}</h6>
                <h6 class="mb-2">{{$data['moveInRequest'][0]->contract->subject}}</h6>
