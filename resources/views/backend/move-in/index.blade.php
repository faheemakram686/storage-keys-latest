            ...
            <div class="nk-block-head">
                <div class="nk-block-between">
                    <div class="nk-block-head-content">
                        <h3 class="nk-block-title page-title">Actual Move-In List</h3>
...
{{--                                        <a href="#" class="btn btn-primary btn-sm"  data-toggle="modal" data-target="#addCountry"><em class="icon ni ni-plus"></em><span>Add Move-In</span></a>--}}
                                        <a href="{{route('move-in.create')}}" class="btn btn-primary btn-sm" ><em class="icon ni ni-plus"></em><span>Add Move-In</span></a>
                                    </li>
                                </ul>
                            </div>
                        </div>
                ...
                <div class="card-inner">
                    <table class="datatable-init-export nk-tb-list nk-tb-ulist" data-auto-responsive="true"  id="datatable" >
                        ...
                        <tr class="nk-tb-item nk-tb-head">
                            ...
                            <th class="nk-tb-col"><span class="sub-text">Moved Items</span></th>
                            <th class="nk-tb-col"><span class="sub-text">Move-In Date</span></th>
