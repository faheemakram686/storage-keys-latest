                                ...
                                <ul class="nk-store-statistics">
                                    <li class="item">
                                        ...
                                        <a href="javascript:void(0)"><em
                                                    class="icon bg-primary-dim ni ni-grid-alt-fill"></em></a>
                                    </li>
                                    <li class="item">
                                        <a href="javascript:void(0)">
                                            <div class="info">
                                    ...
                                    <li class="item">
                                        ...
                                        <a href="javascript:void(0)"><em
                                                    class="icon bg-pink-dim ni ni-calendar-check"></em></a>
                                    </li>
                                </ul>
                            </div><!-- .card-inner -->
                        </div><!-- .card -->
                            ...
                            <div class="nk-ecwg nk-ecwg7 h-100">
                                <div class="card-inner flex-grow-1">
                                    ...
                                    <div class="nk-ecwg7-ck">
                                        ...
                                        <canvas class="ecommerce-doughnut-s1 chartjs-render-monitor"
                                                id="orderStatistics" width="180"
                                                height="180"
                                                style="display: block; width: 180px; height: 180px;"></canvas>
                                    </div>
                                    <ul class="nk-ecwg7-legends">
                                        ...
                                        <li>
                                            <div class="title">
                                                <span class="dot dot-lg sq" data-bg="#13c9f2"
                                                      style="background: rgb(19, 201, 242);"></span>
