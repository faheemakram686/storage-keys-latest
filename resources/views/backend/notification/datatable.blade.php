                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input class="form-control" type="text" name="country_name" placeholder="Name"
                                           required>
                                </div>
                            </div>
                            <div class="col-md-6">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input class="form-control" type="text" name="edit_country_name" placeholder="Name"
                                           required>
                                </div>
                            </div>
                            <div class="col-md-6">
