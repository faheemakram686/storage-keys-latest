            ...
            <div class="nk-block-head">
                <div class="nk-block-between">
                    <div class="nk-block-head-content">
                        <h3 class="nk-block-title page-title">Move-Out List</h3>
...
{{--                                        <a href="#" class="btn btn-primary btn-sm"  data-toggle="modal" data-target="#addCountry"><em class="icon ni ni-plus"></em><span>Add Move-In</span></a>--}}
                                        <a href="{{route('move-out.create')}}" class="btn btn-primary btn-sm" ><em class="icon ni ni-plus"></em><span>Add Move-Out</span></a>
                                    </li>
                                </ul>
                            </div>
                        </div>
                ...
                <div class="card-inner">
                    <table class="datatable-init-export nk-tb-list nk-tb-ulist" data-auto-responsive="true"  id="datatable" >
                        ...
                        <tr class="nk-tb-item nk-tb-head">
                            ...
                            <th class="nk-tb-col"><span class="sub-text">Moved-Out Items</span></th>
                            <th class="nk-tb-col"><span class="sub-text">Move-Out Date</span></th>
        ...
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title text-capitalize" id="ajax_model_title">Add Move-In</h5>
    ...
    <div class="modal fade" tabindex="-1" role="dialog" data-backdrop="static" data-keyboard="false" id="editCountry" aria-hidden="true">
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title text-capitalize" id="ajax_model_title">Edit Movie-In</h5>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                </div>
                ...
                $.ajax({
                    ...
                    success: function(data) {
                        ...
                        for (i = 0; i < data.length; i++) {
                            ...
                            '<li><a href="{{url('admin/view-move-out-items')}}/'+data[i].contract.id+'" class="btn-edit" data='+data[i].id+'><em class="icon ni ni-edit"></em><span>View Move-Out Items</span></a></li>'+
