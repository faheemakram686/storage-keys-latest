        ...
        <div class="nk-block nk-block-lg">
            <div class="nk-block-head">
                <div class="nk-block-between">
                    <div class="nk-block-head-content">
                        <h4 class="title nk-block-title">Edit Move-In</h4>
                    </div>
            ...
            <div class="card">
                <div class="card-inner">
                    <form class="gy-3 form-validate is-alter" action="{{url("admin/save-move-in")}}"  method="post" enctype="multipart/form-data" id="MoveInForm">
                        @csrf
                        <div class="row g-4">
                            <div class="col-lg-6">
...
{{--                                        <div class="nk-notes ff-italic fs-12px text-soft"> Invoice was created on a computer and is valid without the signature and seal. </div>--}}
    ...
    <script>
        $(document).ready(function() {
            ...
            function getBarcodeLabels(contract_id) {
                $.ajax({
                            ...
                            c++;
                               ...
                               html += '<tr id="row'+dr+'" class="dynamic-added">'+
                                ...
                                '<td> ' +
                                 ...
                                 '</td>'+
                                '<td>' +
                                   '<input type="checkbox" name="barcodeItems[selected][]" id="'+dr+'"  value="' +  data[i].id + '" class="checkbox countButton" '+((data[i].status == 'Moved')? 'disabled':'') +' />'+
                                '</td>'+
                                '</tr>';
                            dr++;
                        }
