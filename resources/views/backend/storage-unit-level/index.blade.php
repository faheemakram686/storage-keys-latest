...
@section('title', '| Storage Unit Level')
@section('content')
            ...
            <div class="nk-block-head">
                <div class="nk-block-between">
                    <div class="nk-block-head-content">
                        <h3 class="nk-block-title page-title">Storage Unit Level List</h3>
                            ...
                            <div class="toggle-expand-content" data-content="pageMenu">
                                <ul class="nk-block-tools g-3">
                                    <li class="nk-block-tools-opt">
                                        <a href="#" class="btn btn-primary btn-sm"  data-toggle="modal" data-target="#addCountry"><em class="icon ni ni-plus"></em><span>Add Storage Unit Level</span></a>
                                    </li>
                                </ul>
                            </div>
                        </div>
        ...
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title text-capitalize" id="ajax_model_title">Add New Storage Unit Level</h5>
                ...
                <div class="modal-body" data-form="ajax-form-modal">
                    ...
                    <form method="post" action="{{ url('admin/save-storage-level') }}" id="CountryForm">
                        @csrf
                        <div class="row g-4">
                            ...
                            <div class="col-lg-12">
                                <div class="form-group">
                                    ...
                                    <div class="form-control-wrap">
                                        <textarea type="text" class="form-control" rows="2" id="description" required="" name="description"></textarea>
                                    </div>
                                </div>
                            </div>
    ...
    <div class="modal fade" tabindex="-1" role="dialog" id="editCountry" aria-hidden="true">
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title text-capitalize" id="ajax_model_title">Edit Storage Unit Level</h5>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                </div>
                <div class="modal-body" data-form="ajax-form-modal">
                    ...
                    <form method="post" action="{{ url('admin/update-storage-level') }}" id="updateCountryForm">
                        @csrf
                        ...
                        <div class="row g-4">
                            ...
                            <div class="col-lg-12">
                                <div class="form-group">
                                    <label class="form-label" for="description">Description</label>
                                    <div class="form-control-wrap">
                                        <textarea type="text" class="form-control" rows="2" id="description" required="" name="e_description"></textarea>
                                    </div>
                                </div>
                            </div>
    ...
    <script>
        $(document).ready(function() {
            ...
            $('#CountryForm').on('submit', function(e) {
                ...
                $.ajax({
                    type: "get",
                    url: '{{ url('admin/save-storage-level') }}',
                    data: formData,
                    contentType: false,
                    processData: false,
                    beforeSend: function() {
            ...
            function getAllCities() {
                ...
                $.ajax({
                    ...
                    url: '{{ url('admin/get-storage-level') }}',
                    type: 'get',
                    async: false,
                    dataType: 'json',
            ...
            $('#countryTable').on('click', '.btn-delete', function() {
                var id = $(this).attr('data');
                    $.ajax({
                        url: '{{ url('admin/delete-storage-level') }}',
                        type: 'get',
                        async: false,
                        dataType: 'json',
                        data: { id: id},
            ...
            $('#countryTable').on('click', '.btn-edit', function() {
                ...
                $.ajax({
                    url: '{{ url('admin/edit-storage-level') }}',
                    type: 'get',
                    async: false,
                    dataType: 'json',
                    data: { id: id },
                    success: function(res) {
                        ...
                        $('textarea[name=e_description]').val(res.st.description);
            ...
            $('#updateCountryForm').on('submit', function(e) {
                ...
                $.ajax({
                    type: "get",
                    url: '{{ url('admin/update-storage-level') }}',
                    data: formData,
                    contentType: false,
                    processData: false,
                    beforeSend: function() {
