                                            ...
                                            <div class="offset-lg-1 offset-md-1 col-12 col-sm-12 col-md-10 col-lg-10">
                                                <div class="row mt-3">
                                                    <div class="col-6">
                                                        ...
                                                        <input type="text" class="form-control" name="alt_contact_name" id="alt_contact_name" style="height:35px;">
                                                    </div>
                                                    <div class="col-6">
                                                        <label class="">Email</label>
                                                        <input type="email" class="form-control" name="alt_contact_email" id="alt_contact_email" style="height:35px;">
                                                    </div>
                                                </div>
                                                <div class="row mt-3">
                                                    <div class="col-6">
                                                        <label class="">Mobile number</label>
                                                        <input type="text" class="form-control" name="alt_contact_mobile" id="alt_contact_mobile" style="height:35px;">
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
