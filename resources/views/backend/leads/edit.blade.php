                                                ...
                                                <div class="row mt-3">
                                                    <div class="col-6">
                                                        ...
                                                        <select class="selectpicker form-control  form-select" name="lead_status" id="lead_status">
                                                            ...
                                                            <option value="1" selected>OPEN - quoted</option>
                                                            <option value="2" selected>OPEN - NotContacted</option>
                                                            <option value="3">OPEN - AttemptedContact</option>
                                                            <option value="4">OPEN - Contacted</option>
                                                            <option value="5">CLOSED - Disqualified</option>
                                                        </select>
                                                    </div>
                                                    <div class="col-6">
                                        ...
                                        <div class="row">
                                            <div class="offset-lg-1 offset-md-1 col-12 col-sm-12 col-md-10 col-lg-10">
                                                ...
                                                <div class="row">
                                                    <div class="col-6">
                                                        <div class="form-check">
                                                            <input class="form-check-input" name="price" type="radio" value="monthly"  id="flexCheckDefault" />
                                                ...
                                                <div class="row">
                                                    <div class="col-6">
                                                        <div class="form-check">
                                                            <input class="form-check-input" name="price" type="radio" value="quarterly"  id="flexCheckDefault" />
                                                ...
                                                <div class="row">
                                                    <div class="col-6">
                                                        <div class="form-check">
                                                            <input class="form-check-input" name="price" type="radio" value="bi-annual"  id="flexCheckDefault" />
                                                ...
                                                <div class="row">
                                                    <div class="col-6">
                                                        <div class="form-check">
                                                            <input class="form-check-input" name="price" type="radio" value="annual"  id="flexCheckDefault" />
