...
<div class="nk-block nk-block-middle nk-auth-body  wide-xs">
    <div class="brand-logo pb-4 text-center">
        <a href="/" class="logo-link">
            <img class="logo-light logo-img logo-img-lg" src="{{ asset('assets/images/frontend/front-logo.png') }}"
                srcset="{{ asset('assets/images/logo2x.png') }} 2x" alt="logo">
            <img class="logo-dark logo-img logo-img-lg" src="{{ asset('assets/images/frontend/front-logo.png') }}"
        ...
        <div class="card-inner card-inner-lg">
            ...
            <form method="POST" action="{{ route('register.store') }}">
                ...
                <div class="form-group">
                    ...
                    <div class="form-control-wrap">
                        <input type="email" class="form-control form-control-lg" name="email" id="default-01"
                ...
                <div class="form-group">
                    ...
                    <div class="form-control-wrap">
                        ...
                        <input type="password" class="form-control form-control-lg" name="password_confirmation" id="confirm_password"
