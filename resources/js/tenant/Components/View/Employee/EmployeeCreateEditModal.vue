<template>
    <modal
        ...
        <form
            ...
            ref="form"
            :data-url='selectedUrl ? selectedUrl : EMPLOYEE_CREATE'
...
import {
    ...
    EMPLOYEE_CREATE, AUTO_EMPLOYEE_ID,
} from "../../../Config/ApiUrl";
import {
...
export default {
    ...
    methods: {
        ...
        afterSuccessFromGetEditData({data}) {
            ...
            //Before customization this was "  this.formData = data;"
